             ...
             checked:(BOOL)aChecked
{
    ...
    {
        l.font = [UIFont fontWithName:@"Helvetica-Bold" size:25];
...
//    l.textColor = [UIColor colorWithRed:154 / 255 green:185 / 255 blue:52 / 255 alpha:1.0];
    l.textColor = RgbHex2UIColor(154, 185, 52);
